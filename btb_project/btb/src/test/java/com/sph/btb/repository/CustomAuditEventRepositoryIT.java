package com.sph.btb.repository;

import com.sph.btb.BtbApp;

import com.sph.btb.config.Constants;
import com.sph.btb.config.audit.AuditEventConverter;
...
import static com.sph.btb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
