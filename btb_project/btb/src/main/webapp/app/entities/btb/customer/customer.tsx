        ...
        {customerList && customerList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('idCustomer')}>
                ...
                <th className="hand" onClick={sort('signinDate')}>
            ...
            <tbody>
              {customerList.map((customer, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{customer.city}</td>
                  <td>{customer.signinDate ? <TextFormat type="date" value={customer.signinDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="btbApp.btbCustomer.home.notFound">No Customers found</Translate>
            </div>
          )
        )}
      </div>
